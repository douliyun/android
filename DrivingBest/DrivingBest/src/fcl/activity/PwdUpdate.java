...
public class PwdUpdate extends Activity {
	  EditText mAccount;                        //用户名编辑  
	  EditText mPwd_old;                        //密码编辑  
	  EditText mPwd_new;                        //密码编辑  
	  EditText mPwdCheck;                       //密码编辑  
	        ...
	        public void onClick(View v) {  
	            switch (v.getId()) {  
	                ...
	                case R.id.resetpwd_btn_cancel:                     //取消按钮的监听事件,由注册界面返回登录界面  
	                    Intent intent = new Intent(PwdUpdate.this,DrivingBest.class) ;    //切换Resetpwd Activity至Login Activity  
	            ...
	            if(result==1){                                             
	                ...
	                if(userPwd_new.equals(userPwdCheck)==false){           
	                    ...
	                    if (flag == false) {  
	                        ...
	                        Intent intent_Register_to_Login = new Intent(PwdUpdate.this,Login.class) ;    
